...
<header>
    ...
    <div id="principal">   
        <div class="container text-blue">
            ...
            @csrf 
                <div class="row" >
                    <div class="col-8"><label for="nome">Nome</label><input type="text" name='nome' id='nome' class="form-control formPlaceholder" placeholder='Digite o Nome da Fragrancia'></div>
                </div>
             
                <div class="row" >
                    <div class="col-3"><label for="estoque">Estoque</label><input type="text" name='estoque' id='estoque' class="form-control formPlaceholder" placeholder='0'></div>   
                    <div class="col-3"><label for="total_utilizado">Total Utilizado</label><input type="text" name='total_utilizado' id='total_utilizado' class="form-control formPlaceholder" placeholder='0'></div>
